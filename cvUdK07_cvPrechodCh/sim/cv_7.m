...
y_pb_2=deg2rad(30); %hodnota vıchlylky v pracovnom bode 2

phi_0=y_pb_1*0.0; %poèiatoèná podmienka vıchlylky (môe by rovnaká ako y_pb_1, ale ideálne nulová)
